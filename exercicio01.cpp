...
void primitivas(){
    ...
    glBegin(GL_LINE_LOOP); //conecte uma sequÃªncia de pontos em segmentos de reta e o Ãºltimo ponto com o primeiro
        glVertex2f( 5, 9);
        glVertex2f( 8, 9);
        glVertex2f( 8, 12);
        glVertex2f( 5, 12);
   ...
   /*  glBegin(GL_QUADS); //a cada quatro pontos, conecte-os em quadrilÃ¡teros
        glColor3f(0.0, 0.0, 1.0);
        glVertex2f( -10, -14);
        glVertex2f( -13, -14);
        glVertex2f( -13, -17);
